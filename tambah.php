    ...
    <nav class="navbar navbar-expand-lg bg-primary">
        <div class="container">
            ...
            <div class="navbar-nav">
                ...
                <a class="nav-link text-white" href="tambah.php">Tambah data</a>
            </div>
            </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="fakultas" id="fakultas">
                                ...
                                <option value="pendidikan" <?php if ($fakultas == "pendidikan") echo "selected" ?>>Pendidikan</option>
                            </select>
                        </div>
                    </div>
                        <div class="col-12">
                            <input type="submit" name="simpan" value="Simpan Data" class="btn btn-primary" />
                            <a href="http://localhost:8080/test/index.php" class="btn btn-warning">Batal</a>
                        </div>
                    </div>
                </form>
            </div>
